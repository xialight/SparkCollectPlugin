...
define_fn!(il2cpp_class_for_each, (), klassReportFunc: unsafe extern "C" fn(klass: *mut Il2CppClass, userData: *mut ::std::os::raw::c_void), userData: *mut ::std::os::raw::c_void);
...
define_fn!(il2cpp_type_get_name_chunked, (), type_: *const Il2CppType, chunkReportFunc: unsafe extern "C" fn(data: *mut ::std::os::raw::c_void, userData: *mut ::std::os::raw::c_void), userData: *mut ::std::os::raw::c_void);
...
define_fn!(il2cpp_native_stack_trace, (), ex: *const Il2CppException, addresses: *mut *mut usize, numFrames: *mut ::std::os::raw::c_int, imageUUID: *mut ::std::os::raw::c_char);
...
define_fn!(il2cpp_gc_set_external_allocation_tracker, (), func: unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void, arg2: usize, arg3: ::std::os::raw::c_int));
define_fn!(il2cpp_gc_set_external_wbarrier_tracker, (), func: unsafe extern "C" fn(arg1: *mut *mut ::std::os::raw::c_void));
define_fn!(il2cpp_gc_foreach_heap, (), func: unsafe extern "C" fn(data: *mut ::std::os::raw::c_void, userData: *mut ::std::os::raw::c_void), userData: *mut ::std::os::raw::c_void);
...
define_fn!(il2cpp_gchandle_foreach_get_target, (), func: unsafe extern "C" fn(data: *mut ::std::os::raw::c_void, userData: *mut ::std::os::raw::c_void), userData: *mut ::std::os::raw::c_void);
...
define_fn!(il2cpp_unity_liveness_calculation_begin, *mut ::std::os::raw::c_void, filter: *mut Il2CppClass, max_object_count: ::std::os::raw::c_int, callback: il2cpp_register_object_callback, userdata: *mut ::std::os::raw::c_void, onWorldStarted: il2cpp_WorldChangedCallback, onWorldStopped: il2cpp_WorldChangedCallback);
define_fn!(il2cpp_unity_liveness_calculation_end, (), state: *mut ::std::os::raw::c_void);
